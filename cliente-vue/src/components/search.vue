<template>
  ...
  <div class="col">
    <div class="text-center" id="searchBar" style="font-size: 34px;padding: 4px;height: 154px;">
        <h1 class="display-4 text-center" id="headingSearchBar" style="font-size: 40px;color: rgb(25,22,22);height: 26px;margin: 17px;padding: 0px;">
          <strong>Search</strong>
        </h1>
        <input class="form-control-lg" type="text" id="textSearchBar" placeholder="Songs, artists, albums..." style="width: 309px;">
    </div>
